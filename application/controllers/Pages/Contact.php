...
class Contact extends My_Controller 
{
	public function __construct()
	{
		...
		$this->is_logged_in(1);
		$this->canAccess('employee',['index'],'contact');
		$this->canAccess('customer',['index'],'contact');
	...
	public function index() {
		...
		$data = [];
		$data['flag'] 		= "1";
		$data['template'] 	= 'pages/contact/contact_view';
	...
	public function edit() {
		...
		$data = [];
		$data['template'] 	= 'pages/contact/contact_edit';
		$data['flag'] 		= "1";
		$data['title'] 		= "Contact";
		$data['data'] 		= $page;
		$this->load->view('default', $data);
