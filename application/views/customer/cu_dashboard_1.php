...
<div class="col-lg-4 col-md-4 col-sm-12">
	...
	<div class="card-body text-center">
		<a href="<?php echo site_url('customer/complaint');?>?status=2">
			<div class="content">
			<p class="text-muted mt-2 mb-0">Open Tickets Enquiry</p>
	...
	<div class="card-body text-center">
		...
		<div class="content">
		<p class="text-muted mt-2 mb-0">Ongoing Tickets Enquiry</p>
	...
	<div class="card-body text-center">
		...
		<div class="content">
		<p class="text-muted mt-2 mb-0">Completed Tickets Enquiry</p>
	...
	<div class="card-body text-center">
		...
		<div class="content">
		<p class="text-muted mt-2 mb-0">Closed Tickets Enquiry</p>
	...
	<a href="<?php echo site_url('customer/complaint'); ?>" class="btn btn-rounded btn-primary "> View All</a>
</div>
