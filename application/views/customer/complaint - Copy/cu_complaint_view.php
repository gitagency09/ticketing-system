  ...
  foreach ($history as $key => $value) {
      ...
      <div class="row">
        ...
        <div class="col-md-4">   
          ...
          <div class="col-md-7 text-capitalize"><p><?php echo ps($value,'emp_name'); ?></p></div>
          </div>
        </div>
        ...
        <?php if($value['conversation_id']){ ?>
            <div class="col-md-2">   
            <div class="row">
            <div class="col-md-8 "><p><a class="btn btn-primary" type="button" data-dismiss="modal" href="<?php echo site_url('chat/'.$value['conversation_id']); ?>">CHAT</a></p></div>
            </div>
            </div>
        <?php  }  ?>
...
<?php
  ...
  if( $complaint['status'] == 1) { //if status is completed 
