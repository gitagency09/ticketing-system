...
<div class="mt-4 mb-4 step1">  
	...
	<div class="row ">
		<div class="col-md-4 form-group mb-3">
			<input class="form-control" id="comapny_name" type="text" placeholder="Company Name" value="<?php echo $company['name']; ?>" readonly="true" />
		</div>

		<div class="col-md-4 form-group mb-3">
			<input class="form-control" id="customer_name" type="text" placeholder="Customer Name" value="<?php echo $data['first_name']. ' '.$data['last_name']; ?>" readonly="true" />
		</div>
  ...
  <!-- start step 2 --> 
<div class="mt-4 mb-4 step2 d-none">  
