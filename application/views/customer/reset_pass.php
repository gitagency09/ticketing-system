...
<html lang="en">
    <head>
        ...
        <title>Reset Password | Ticketing</title>
...
<script type="text/javascript">
    ...
    $('#reset_pass').click(function(e){
        ...
        let $token        = $('#reset_pass_form [name=token]').val();
        let $email        = $('#email').val();
        ...
        if($pass_1 === ""){
            ...
            $('.error_pass_1').html('Password must be more than 8 digits and must contain at least one lower & upper case letter, one digit, and a special character');
            $error = 1;
        } else {
            $('.error_pass_1').html('');
        }
        ...
        grecaptcha.ready(function() {
            grecaptcha.execute('6LddUPkqAAAAAPsgTYwQC2gAp1vGBtW0xAoPp-1_', {action: 'reset_password'}).then(function(token) {
                ...
                let postdata = {
                    ...
                    token: $token,
                    captcha: token // reCAPTCHA v3 token here
                };
