...
<div class="">
	<div class="float-left breadcrumb"><h1 class="mr-2">Add Designation </h1></div>
...
<?php echo form_open_multipart('designation/create',array('id' => 'resgnForm','autocomplete' => 'off') ); ?>
<div class="mt-4 mb-4">  
