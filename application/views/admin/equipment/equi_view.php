...
<div class="">
	<div class="float-left breadcrumb"><h1 class="mr-2">Equipment View</h1></div>
	<div class="float-right">
	<a class="btn btn-primary" type="button" data-dismiss="modal" href="<?php echo $back_url; ?>"><i class="i-Left-3"></i> Back</a>
	<a class="btn btn-primary" type="button" data-dismiss="modal" href="<?php echo site_url('equipment/'.$data['id'].'/edit'); ?>"><i class="i-File-Edit"></i> Edit</a>
	</div>
...
<div class="col-md-4">   
<div class="row">
<div class="col-md-4"><p><b>Model:</b></p> </div>  
<div class="col-md-8">
	<?php
