...
<div class="">
<div class="float-left breadcrumb"><h1 class="mr-2">All Spare Parts</h1></div>
<div class="float-right"><a class="btn btn-primary" type="button" data-dismiss="modal" href="<?php echo site_url('sparepart/create'); ?>"><i class="i-Add-File"></i> Add</a></div>
    	...
    	var table =  $('#zero_configuration_table').DataTable({
	        ...
	        "bInfo":true,
	         "columnDefs": [{
	           ...
	           serverSide: true,
	            ajax: {
			        url: "<?php echo site_url('sparepart/list') ?>",
			        // dataSrc :'data',
	           ...
	           columns: [
	                    ...
	                    { data: 'model' },
	                   {
	                    ...
	                    {
					      "render": function(data, type, full, meta) {
					        $html = '<a class="text-success mr-2 text-18" href="<?php echo site_url() ?>sparepart/'+full.id+'" data-toggle="tooltip" data-placement="top" title="View"><i class="nav-icon i-Eye font-weight-bold"></i></a>';

							$html += '<a class="text-success mr-2 text-18" href="<?php echo site_url() ?>sparepart/'+full.id+'/edit" data-toggle="tooltip" data-placement="top" title="Edit"><i class="nav-icon i-File-Edit"></i></a>';
