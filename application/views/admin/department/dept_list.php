...
<div class="">
<div class="float-left breadcrumb"><h1 class="mr-2">All Departments</h1></div>
<div class="float-right"><a class="btn btn-primary" type="button" data-dismiss="modal" href="<?php echo site_url('department/create'); ?>"><i class="i-Add-File"></i> Add</a></div>
	                    ...
	                    // { data: 'top_dept' },
	                   {
	                    ...
	                    { data: 'created_at' },
	                    {
					      "render": function(data, type, full, meta) {
					        ...
					        $html = '<a class="text-success mr-2 text-18" href="<?php echo site_url() ?>department/'+full.id+'" data-toggle="tooltip" data-placement="top" title="View"><i class="nav-icon i-Eye font-weight-bold"></i></a>';

							$html += '<a class="text-success mr-2 text-18" href="<?php echo site_url() ?>department/'+full.id+'/edit" data-toggle="tooltip" data-placement="top" title="Edit"><i class="nav-icon i-File-Edit"></i></a>';
