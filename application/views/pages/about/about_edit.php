...
<div class="">
<div class="float-left breadcrumb"><h1 class="mr-2">Edit About us</h1></div>
<div class="float-right"><a class="btn btn-primary" type="button" data-dismiss="modal" href="<?php echo site_url('about'); ?>"> VIEW PAGE</a></div>
...
<?php echo form_open_multipart('about/edit',array('id' => 'cmsForm','autocomplete' => 'off') ); ?>
<div class="mt-4 mb-4">  
            ...
            $.ajax({
              type: 'post',
                ...
                success: function($res) {
                    if($res.status == 1){
                      window.location.href = "<?php echo site_url('about/edit')?>";
                      return false;
                    }
                    else{
