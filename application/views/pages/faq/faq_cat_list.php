...
<div class="">
<div class="float-left breadcrumb"><h1 class="mr-2">FAQ Category List</h1></div>
<div class="float-right"><a class="btn btn-primary" type="button" data-dismiss="modal" href="<?php echo site_url('faq/category/create'); ?>"><i class="i-Add-File"></i> Add</a></div>
    	...
    	if($faq){
    		foreach ($faq as $key => $value) {
    			echo '<tr>
					...
					<td><a class="text-success mr-2" href="'.site_url('faq/category/'.$value['id'].'/edit').'"><i class="nav-icon i-File-Edit font-weight-bold"></i></a></td>
					</tr>';
    		}
    	}
    ?>
