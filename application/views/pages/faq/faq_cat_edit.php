...
<div class="">
    <div class="float-left breadcrumb"><h1 class="mr-2">Edit FAQ Category </h1></div>
...
<?php echo form_open_multipart('faq/category/'.$faq['id'].'/update',array('id' => 'cmsForm','autocomplete' => 'off') ); ?>
<div class="mt-4 mb-4">  

<div class="row">

<div class="col-md-8 form-group mb-3"><label for=" ">Name</label>
            ...
            $.ajax({
              type: 'post',
                ...
                success: function($res) {
                    ...
                    if($res.status == 1){
                        window.location.href = "<?php echo site_url('faq/category/'.$faq['id'].'/edit')?>";
                        return false;
                    }
                    else{
