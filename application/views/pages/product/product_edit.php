...
<div class="">
<div class="float-left breadcrumb"><h1 class="mr-2">Products</h1></div>
...
<?php echo form_open_multipart('product/edit',array('id' => 'cmsForm','autocomplete' => 'off') ); ?>
<div class="mt-4 mb-4">  

<div class="row">
    <div class="col-md-12 form-group mb-3"><label>Title</label>
        <input class="form-control" type="text"  name="title" value="<?php echo ps($data,'title');?>" /></div>

    <div class="col-md-12 form-group mb-5 d-none">
...
<div class="row banner_heading ">
    <div class="col-md-12 form-group mt-3 ">
        <label for=" ">Banners <i>[ Size : 770w x 590h] </i></label>
    </div>
</div>

<div class="form-row banner_section">
    <?php
        $image_arr = json_decode($data['image'],true);
        ...
        // console.log(this.files);
          ...
          if (this.files && this.files[0]) {
              ...
              img.onload = function() {
                    ...
                    if($err == 1){
                        alert('Invalid image dimensions. height');
                        $parent.find('.banner_image').val('');
                        $parent.find('.image_preview').attr('src', '#');
                        $parent.find('.preview_div').hide();
                        return false;
                    }
                  // $('#preview').append(img);
