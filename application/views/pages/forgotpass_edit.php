...
<div class="">
<div class="float-left breadcrumb"><h1 class="mr-2">Edit Forgot Password Page</h1></div>
...
<?php echo form_open_multipart('forgotpass/edit',array('id' => 'cmsForm','autocomplete' => 'off') ); ?>
<div class="mt-4 mb-4">  
...
*/
    if($('.banner_section .banner_div').length > 0 ){
     ...
     $('.add_banner').on('click',function(){
        ...
        if($('.banner_section .banner_div').length >= 10){
            alert('You can not add more than 10 banner');
            return false;
        }
        $('.banner_heading').show();
            ...
            $.ajax({
              type: 'post',
                ...
                success: function($res) {
                    ...
                    if($res.status == 1){
                      window.location.href = "<?php echo site_url('forgotpass/edit')?>";
                      return false;
                    }
                    else{
