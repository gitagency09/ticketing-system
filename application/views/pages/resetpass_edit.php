...
<div class="">
<div class="float-left breadcrumb"><h1 class="mr-2">Edit Reset Password Page</h1></div>
...
<?php echo form_open_multipart('resetpass/edit',array('id' => 'cmsForm','autocomplete' => 'off') ); ?>
<div class="mt-4 mb-4">  
            ...
            $.ajax({
              type: 'post',
                ...
                success: function($res) {
                    ...
                    if($res.status == 1){
                      window.location.href = "<?php echo site_url('resetpass/edit')?>";
                      return false;
                    }
                    else{
